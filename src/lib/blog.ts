...
export const articleToolMapping: Record<string, string[]> = {
  ...
  "privacy-first-tools": [],
  "local-first-ai-2026": ["ai-workspace", "notes", "planner", "day-planner", "pomodoro", "password-generator", "qr-generator", "image-converter", "color-picker", "base64", "revision-planner", "habit-tracker", "stopwatch"],
  "solo-entrepreneur-tech-stack": ["ai-workspace", "notes", "planner", "day-planner", "pomodoro", "kanban", "password-generator", "qr-generator", "url-shortener", "image-converter", "color-picker", "currency-converter", "loan-calculator", "profit-calculator", "income-tax-calculator", "compound-interest", "savings-goal-calculator", "retirement-calculator", "bmi-calculator", "pdf-merger", "pdf-splitter", "pdf-compressor", "pdf-converter", "json-formatter", "regex-tester", "markdown-preview", "blog-generator", "text-cleaner", "base64", "habit-tracker", "stopwatch", "document-converter"],
  "humanizer-shift-ai-writing": ["ai-workspace", "text-cleaner", "notes", "planner", "blog-generator", "json-formatter", "markdown-preview", "regex-tester", "password-generator", "qr-generator", "pomodoro", "image-converter", "day-planner", "document-converter"],
...
function buildMeta(fm: Record<string, unknown>, content: string, slug: string): BlogMeta {
  ...
  return {
    ...
    author: String(fm.author || "Zilita Team"),
    category,
    tags,
