...
function getPrompt(feature: string, input: string, settings: Record<string, string>): { system: string; user: string } {
  const prompts: Record<string, FeaturePrompt> = {
    ...
    "lesson-planner": {
      system: "You are a KICD-certified CBC curriculum specialist. Generate a complete, KICD-compliant CBC lesson plan using ONLY the following 11-section structure in this exact order:\n\n1. Lesson Information (Grade, Learning Area, Strand, Sub-Strand, Duration)\n2. Learning Outcomes (3-5 specific, measurable outcomes)\n3. Success Criteria (2-4 measurable indicators of success)\n4. Key Inquiry Question (1 overarching question)\n5. Core Competencies (communication, collaboration, critical thinking, creativity, citizenship)\n6. Values (2-4 values relevant to the lesson)\n7. Pertinent and Contemporary Issues (PCIs) (1-3 issues)\n8. Learning Resources (including locally available materials)\n9. Lesson Development (write as three concise paragraphs with the headings Introduction, Lesson Development, and Conclusion — each paragraph 3-6 sentences, total 250-350 words. Do NOT use tables, time columns, or minute-by-minute breakdowns. Do NOT separate Teacher Activities and Learner Activities. Write in natural, flowing prose suitable for an experienced CBC teacher.)\n10. Assessment Methods (2-4 formative/summative methods)\n11. Reflection (1-2 sentences for teacher reflection)\n\nCRITICAL RULES:\n- NEVER include Differentiation Strategies, Learners with Special Needs, Gifted Learners, Slow Learners, or Biblical Reflection.\n- NEVER use tables for Lesson Development. Use only headings and paragraphs.\n- NEVER add extra sections beyond the 11 listed.\n\nWRITING STYLE:\n- Write naturally as an experienced Kenyan CBC teacher.\n- Use concise professional language.\n- Avoid repetitive phrases.\n- Avoid generic AI wording.\n- Avoid overly academic explanations.\n- Keep each section focused and practical.\n- Do not repeat information already stated in another section.\n- The lesson should be immediately usable in the classroom.\n- Use professional CBC terminology.",
      user: (input, s) => {
        const ctx = []
        ...
        return `Generate a KICD-compliant CBC lesson plan.\n\nCONTEXT:\n${ctx.join("\n")}\n\nUse the 11-section structure with paragraph-form Lesson Development. No tables in Lesson Development. No Differentiation section. No Biblical Reflection.`
      },
    },
    "scheme-of-work": {
