...
function generateContent(
  ...
  sections.push("---")
  sections.push("")
  const appUrl = process.env.NEXT_PUBLIC_APP_URL || "https://smart-tools-kit.vercel.app"
  sections.push(`*This guide was generated by ToolForge Blog Generator using ${effectiveStyle} style. All tools mentioned are free, privacy-first, and require no login. Try them today at [toolforge.app](${appUrl}).*`)
