...
function generateContent(
  ...
  sections.push(`- **Related Zilita tools**: Use our free tools to put these concepts into practice.`)
  sections.push("")
  ...
  sections.push("")
  sections.push(`Zilita offers a suite of free, privacy-first tools that support your work with ${lower}. All tools run entirely in your browser — nothing is uploaded to any server, and no account is required.`)
  sections.push("")
  sections.push("Key benefits of using Zilita tools:")
  sections.push("")
  ...
  sections.push("---")
  sections.push("")
  const appUrl = process.env.NEXT_PUBLIC_APP_URL || "https://zilita.com"
  sections.push(`*This guide was generated by Zilita Blog Generator using ${effectiveStyle} style. All tools mentioned are free, privacy-first, and require no login. Try them today at [zilita.com](${appUrl}).*`)
