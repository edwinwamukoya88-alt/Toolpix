      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          <CardContent className="p-6 space-y-4">
            ...
            <textarea value={input} onChange={(e) => setInput(e.target.value)} rows={6} placeholder={mode === "encode" ? "Hello World" : "SGVsbG8gV29ybGQ="} className="w-full rounded-md border bg-background p-3 text-sm font-mono resize-y" />
