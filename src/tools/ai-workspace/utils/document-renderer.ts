...
<div style="text-align:center;font-size:9px;color:#999;border-top:1px solid #ddd;padding-top:8px;margin-top:30px;">
  Generated by Zilita AI Assistant &bull; ${escapeHtml(docTitle)} &bull; ${now}
</div>
...
export function renderKicdPrintHtml(opts: RenderOptions): string {
  ...
  return html.replace(
    "</body>",
    `<div class="page-footer">Generated by Zilita AI Assistant | ${getDocumentTitle(opts.featureId)} | ${formatDate(opts.generatedAt)} | Page <span class="pagenum"></span></div>\n</body>`,
  )
}
