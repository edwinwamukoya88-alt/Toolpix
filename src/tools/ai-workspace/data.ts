...
export const DESIGN_FEATURES: FeatureDef[] = [
  ...
  { id: "poster", name: "Poster", description: "Design posters with HTML preview", icon: Image, color: "text-violet-400", category: "design", settings: [{ key: "posterTitle", label: "Poster Title", type: "text", placeholder: "e.g., School Open Day" }, { key: "description", label: "Description", type: "text", placeholder: "Brief description" }, { key: "organization", label: "Organization", type: "text", placeholder: "e.g., Zilita Academy" }], promptPlaceholder: "Describe the poster you want to design..." },
  { id: "certificate", name: "Certificate", description: "Design elegant certificates", icon: Award, color: "text-yellow-400", category: "design", settings: [{ key: "certName", label: "Recipient Name", type: "text", placeholder: "Full name" }, { key: "certTitle", label: "Certificate Title", type: "text", placeholder: "e.g., Certificate of Achievement" }, { key: "issuedBy", label: "Issuing Organization", type: "text", placeholder: "e.g., Zilita" }], promptPlaceholder: "Describe the certificate you want to design..." },
