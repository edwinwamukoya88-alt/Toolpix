    ...
    <div className="min-h-[calc(100vh-4rem)]">
      ...
      <section className="container py-12">
        <div className="max-w-3xl mx-auto prose prose-invert prose-sm md:prose-base">
          ...
          <p>Zilita does not collect, store, or transmit any personal data. All tools run entirely in your browser using client-side JavaScript. No files, text, or data you input is ever sent to any server.</p>
          ...
          <h2>Cookies</h2>
          <p>Zilita does not use tracking cookies. We may use essential cookies for functionality (such as remembering your theme preference). No third-party analytics or tracking services are used.</p>

          <h2>Third-Party Services</h2>
          <p>Zilita does not integrate with any third-party analytics, tracking, or advertising networks that collect personal data. Ad placements are rendered client-side and do not share your data with external services.</p>
